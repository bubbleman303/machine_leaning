...
ccn.batch_train(train_value, train_label, epochs=5, save_param_name="mnist_sf_version")

# new_ccn = ConvolutionNeuralNetwork(load_nn_name="mnist_sf_version")
# pre = new_ccn.predict(train_value[:200])
# print(ccn.mini_accuracy(pre, train_label[:200]))
# print(ccn.accuracy(train_value[:200],train_label[:200]))
