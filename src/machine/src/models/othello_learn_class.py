...
class OthelloLearn:
    def __init__(self, lr=0.03, activation_mode="lr", optimizer="adam", depth=2, one_output_hidden_size=16,
                 loss_layer="ms",
                 ):
        ...
        self.depth = depth
        self.one_output_hidden_size = one_output_hidden_size
    ...
    def _get_one_output(self, i, c_num):
        ...
        net.add_affine(i, self.one_output_hidden_size)
        net.add_activation()
        net.add_batch()
        for _ in range(self.depth):
            net.add_affine(self.one_output_hidden_size, self.one_output_hidden_size)
            net.add_activation()
            net.add_batch()
        net.add_affine(self.one_output_hidden_size, 1)
